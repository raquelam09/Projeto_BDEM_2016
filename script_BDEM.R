...
# Leitura do banco de dados SIM_2016
dados_sim <- read.csv2("SIM_2016.csv")
# Verificar se a leitura foi feita corretamente (deve retornar 1309774 e 87)
dim(dados_sim) 
...
# Verificar a frequência das variáveis categóricas
...
# Avaliar os valores da variável IDADE
...
write.csv2(SIM_SP, "SIM_SP.csv", row.names = FALSE)
...
# Leitura do banco de dados SINASC_2016
dados_sinasc <- read.csv2("SINASC_2016.csv")

# Verificar se a leitura foi feita corretamente
dim(dados_sinasc)

# Verificar a estrutura dos dados
str(dados_sinasc)

# Colocar todos os nomes das variáveis em letra maiúscula
...
# Verificar se os nomes das colunas estão de acordo com o roteiro
names(dados_sinasc_1)

# Verificar a dimensão do novo banco
dim(dados_sinasc_1)
